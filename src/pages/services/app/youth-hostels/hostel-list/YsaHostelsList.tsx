...
import { useYouthHostels } from '@/tanstack/services/youth-hostels/youth-hostel.query';
...
const YsaHostelsList = () => {
  document.title = `Youth Hostels | ${titles.SERVICES_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useYouthHostels({
    page: currentPage,
    search: debounced,
  });
      ...
      <AppBodyWrapper>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="col-span-3">
            ...
            <div className="mb-3">
              <Link
                to={`${titles.SERVICES_APP_URL}/youth-hostels/youth-hostel`}
              >
