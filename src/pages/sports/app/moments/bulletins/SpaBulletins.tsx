...
import { useBulletins } from '@/tanstack/sports/moments/moments.query';
...
const SpaBulletins = () => {
  ...
  const { data, isLoading, isFetching, isError, error } = useBulletins({
  ...
  return (
    <>
      <AppTitleWrapper title="Bulletins" isFetching={isLoading || isFetching} />
      <AppBodyWrapper>
