...
import { useStadiums } from '@/tanstack/sports/info-about/info-about.query';
...
const SpaStadiums = () => {
  ...
  const { data, isLoading, isFetching, isError, error } = useStadiums({
  ...
  return (
    <>
      <AppTitleWrapper title="Stadiums" isFetching={isLoading || isFetching} />
      <AppBodyWrapper>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="col-span-3">
            ...
            <div className="mb-3">
              <Link to={`${titles.SPORTS_APP_URL}/info-about/stadium`}>
