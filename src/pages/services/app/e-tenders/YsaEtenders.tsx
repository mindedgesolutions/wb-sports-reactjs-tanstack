...
import { useEtenders } from '@/tanstack/services/e-tenders/e-tender.query';
...
const YsaEtenders = () => {
  document.title = `E-Tenders | ${titles.SERVICES_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useEtenders({
    page: currentPage,
    search: debounced,
  });
  ...
  return (
    <>
      <AppTitleWrapper title="E-Tenders" isFetching={isLoading || isFetching} />
      <AppBodyWrapper>
