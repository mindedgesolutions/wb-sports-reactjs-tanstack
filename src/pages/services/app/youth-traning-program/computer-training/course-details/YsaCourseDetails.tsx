...
import { useCompCourseDetails } from '@/tanstack/services/youth-training/comp-training.query';
...
const YsaCourseDetails = () => {
  document.title = `Computer Course Details | ${titles.SERVICES_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useCompCourseDetails({
    page: currentPage,
    search: debounced,
  });
