...
import { useProfileUpdateSports } from '@/tanstack/shared/auth/auth.mutation';
...
const SpaProfile = () => {
  ...
  const update = useProfileUpdateSports();

  // -----------------------------------

  const { data: user, isLoading } = useCurrentUser('sports') as {
    data: IUser;
    isLoading: boolean;
  };
