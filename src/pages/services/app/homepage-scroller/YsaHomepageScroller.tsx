...
import { useHomepageScrollers } from '@/tanstack/services/homepage-scrollers/homepage-scroller.query';
...
const YsaHomepageScroller = () => {
  document.title = `Homepage Top Scrollers | ${titles.SERVICES_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useHomepageScrollers({
    page: currentPage,
    search: debounced,
  });
