...
import { useDistrictBlockOffices } from '@/tanstack/services/about-us/about-us.query';

const YsaDistrictOffices = () => {
  document.title = `District / Block Offices | ${titles.SERVICES_APP_NAME}`;
