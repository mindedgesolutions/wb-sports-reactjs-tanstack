  ...
  return (
    <div className="relative flex flex-col items-center min-h-48 md:min-h-64 gap-4">
      ...
      <div className="mt-0 md:mt-2.5 flex flex-col items-center">
        <span className="text-primary min-h-10 md:min-h-auto text-center leading-tight md:leading-normal font-inter font-semibold tracking-wider text-sm md:text-lg">
          {data.name}
        </span>
        <span className="mt-2 md:mt-4 min-h-10 md:min-h-10 text-center text-card-foreground text-xs md:text-sm font-inter tracking-wider leading-4 [text-align-last:center]">
          {data.designation}
        </span>
