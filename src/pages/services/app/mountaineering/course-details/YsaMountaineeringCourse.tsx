...
import { useMountainCourses } from '@/tanstack/services/mountaineering/mountaineering.query';
...
const YsaMountaineeringCourse = () => {
  document.title = `Mountaineering Course Details | ${titles.SERVICES_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useMountainCourses({
    page: currentPage,
    search: debounced,
  });
  ...
  return (
    <>
      <AppTitleWrapper
        title="Mountaineering Course Details"
...
export default YsaMountaineeringCourse;
