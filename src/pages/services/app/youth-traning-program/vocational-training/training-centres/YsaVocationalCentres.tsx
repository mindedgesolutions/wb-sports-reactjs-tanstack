...
import { useVocTrainingCentres } from '@/tanstack/services/youth-training/voc-training.query';
...
const YsaVocationalCentres = () => {
  document.title = `Vocational Training Centres | ${titles.SERVICES_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useVocTrainingCentres(
    {
      page: currentPage,
      search: debounced,
    },
