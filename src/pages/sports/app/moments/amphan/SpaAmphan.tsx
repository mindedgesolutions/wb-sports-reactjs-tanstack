...
import { useAmphanPhotos } from '@/tanstack/sports/moments/moments.query';
...
const SpaAmphan = () => {
  document.title = `Amphan Photos | ${titles.SPORTS_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useAmphanPhotos({
