...
import { useCompSyllabus } from '@/tanstack/services/youth-training/comp-training.query';
...
const YsaCourseSyllabus = () => {
  document.title = `Computer Course Syllabus (PDF) | ${titles.SERVICES_APP_NAME}`;
  ...
  const { data, isLoading, isFetching, isError, error } = useCompSyllabus({
    page: currentPage,
    search: debounced,
  });
  ...
  return (
    <>
      <AppTitleWrapper
        title="Computer Course Syllabus (PDF)"
