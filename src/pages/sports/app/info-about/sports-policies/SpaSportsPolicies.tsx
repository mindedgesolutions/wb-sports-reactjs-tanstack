...
import { useSportsPolicies } from '@/tanstack/sports/info-about/info-about.query';
...
const SpaSportsPolicies = () => {
  ...
  const { data, isLoading, isFetching, isError, error } = useSportsPolicies({
...
export default SpaSportsPolicies;
