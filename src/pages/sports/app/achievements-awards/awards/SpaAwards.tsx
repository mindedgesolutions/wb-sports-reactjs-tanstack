...
import { useAwards } from '@/tanstack/sports/achievements-awards/achievements-awards.query';
...
const SpaAwards = () => {
  ...
  const { data, isLoading, isFetching, isError, error } = useAwards({
  ...
  return (
    <>
      <AppTitleWrapper title="Awards" isFetching={isLoading || isFetching} />
      <AppBodyWrapper>
